 ...
 <script>
        ...
        $("#testId").on("keyup", function(){
            ...
            debounceTimer = setTimeout(function(){
                $.ajax({
                    ...
                    error: function(){
                        $("#testTable").html("<tr><td colspan='9'>Error fetching data</td></tr>");
                    }
                });
            }, 300);
        });
         $("#productId").on("keyup", function(){
            ...
            debounceTimer = setTimeout(function(){
                $.ajax({
                    url: "ajax/searchbyProductId.php",
                    type: "POST",
    ...
    debounceTimer = setTimeout(function () {
        ...
        $.ajax({
            ...
            error: function () {
                $("#testTable").html("<tr><td colspan='9'>Error loading data</td></tr>");
            }
        });
    }, 300);
});
